...
const CodePage = () => {
    ...
    const onSubmit = async (values: z.infer<typeof formSchema>) => {
        ...
        try {
            ...
            // In case of 404 error, which we through on API limit expiry, open the pro modal.
    ...
    return (
        <div>
            <Heading
                ...
                description="Generate code usign the descriptive text"
                icon={Code}
            ...
            <div className="px-4 lg:px-8">
                <div>
                    <Form {...form}>
                        ...
                        p-4 px-3 md:px-6 focus-withing:shadow-sm
                        grid
                        grid-cols-12
                        gap-2"
                        >
